...
<html lang="en">
    <head>
        ...
        <link rel="manifest" href="<?php echo base_url($assets_dir. '/manifest.json'); ?>">
        <link rel="mask-icon" href="safari-pinned-tab.svg" color="#27ae60">
        <meta name="theme-color" content="#ffffff">
        <link rel="stylesheet" href="<?php echo base_url($fonts_dir. '/fontawesome-webfont5b62.html?v=4.6.3'); ?>">
        ...
        <link rel="stylesheet" href="<?php echo base_url($css_dir. '/login-1.min.css'); ?>">
