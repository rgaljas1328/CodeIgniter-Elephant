...
<html lang="en">
        ...
        <script src="<?php echo base_url($js_dir . '/jquery.min.js'); ?>"></script>
        <script src="<?php echo base_url($js_dir . '/restclient.js'); ?>"></script>
        <link rel="stylesheet" href="<?php echo base_url($css_dir. '/vendor.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($css_dir. '/elephant.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($css_dir. '/application.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($css_dir. '/demo.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($css_dir. '/font-awesome.css'); ?>">
        </head>
